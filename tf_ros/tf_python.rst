...
.. exception:: Exception
    ...
    base class for tf_ros exceptions.  Because :exc:`tf_ros.Exception` is the
    base class for other exceptions, you can catch all tf_ros exceptions
    by writing::

        try:
            # do some tf_ros work
        except tf_ros.Exception:
            print "some tf_ros exception happened"
...
.. exception:: LookupException
   ...
   subclass of :exc:`Exception`.
   Raised when a tf_ros method has attempted to access a frame, but
...
.. exception:: ExtrapolationException
   ...
   subclass of :exc:`Exception`
   Raised when a tf_ros method would have required extrapolation beyond current limits.


Transformer
-----------

.. class:: tf_ros.Transformer(interpolating, cache_time = rospy.Duration(10))

   :param interpolating: Whether to interpolate transformations.
   :param cache_time: how long tf_ros should retain transformation information in the past.

   The Transformer object is the core of tf_ros. It maintains a
   ...
   To use tf_ros with ROS messages, see :class:`TransformerROS` and :class:`TransformListener`.
    ...
    .. method::  waitForTransform(target_frame, source_frame, time, timeout, polling_sleep_duration = rospy.Duration(0.01))
        ...
        :param target_frame: transformation target frame in tf_ros, string
        :param source_frame: transformation source frame in tf_ros, string
        ...
        :raises: :exc:`tf_ros.Exception`

        Waits for the given transformation to become available.
        If the timeout occurs before the transformation becomes available, raises :exc:`tf_ros.Exception`.
    ...
    .. method::  chain(target_frame, target_time, source_frame, source_time, fixed_frame) -> list
        ...
        :param source_time: time of transformation in target_frame, a :class:`rospy.Time`
        :param fixed_frame: reference frame common to both target_frame and source_frame.
        :returns: list of tf_ros frames
        :raises: :exc:`tf_ros.ConnectivityException`, :exc:`tf_ros.LookupException`
    ...
    .. method::  frameExists(frame_id) -> Bool
        ...
        :param frame_id: a tf_ros frame, string
    ...
    .. method::  getLatestCommonTime(source_frame, target_frame) -> time
        ...
        Raises :exc:`tf_ros.Exception` if transformation is not possible.
    ...
    .. method::  lookupTransform(target_frame, source_frame, time) -> (position, quaternion)
        ...
        :raises: :exc:`tf_ros.ConnectivityException`, :exc:`tf_ros.LookupException`, or :exc:`tf_ros.ExtrapolationException`
    ...
    .. method:: lookupTwist(tracking_frame, observation_frame, time, averaging_interval) -> linear, angular
        ...
        Simplified version of :meth:`tf_ros.lookupTwistFull`.

        Return the linear and angular velocity of the moving_frame in the reference_frame.  tf_ros considers 
...
.. autoclass:: tf_ros.TransformerROS
    :members:

TransformListener
-----------------

.. autoclass:: tf_ros.TransformListener

TransformBroadcaster
--------------------

.. autoclass:: tf_ros.TransformBroadcaster
    :members:
