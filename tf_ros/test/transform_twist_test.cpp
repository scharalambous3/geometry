...
protected:
  ...
  TransformTwistLinearTest() {
    ...
    for (double t = 0.1; t <= 6; t += 0.1)
    {
      ...
      tf_.setTransform(StampedTransform(tf_ros::Transform(tf_ros::createIdentityQuaternion(), tf_ros::Vector3(x, y, z)), ros::Time(t), "foo", "bar"));
      tf_.setTransform(StampedTransform(tf_ros::Transform(tf_ros::createIdentityQuaternion(), tf_ros::Vector3(1,0,0)), ros::Time(t), "foo", "stationary_offset_child"));
      tf_.setTransform(StampedTransform(tf_ros::Transform(tf_ros::createIdentityQuaternion(), tf_ros::Vector3(0,0,1)), ros::Time(t), "stationary_offset_parent", "foo"));
    }
...
protected:
  ...
  TransformTwistAngularTest() {
    ...
    for (double t = 0.1; t < 6; t += 0.1)
    {
      ...
      tf_.setTransform(StampedTransform(tf_ros::Transform(tf_ros::createQuaternionFromRPY(x, y, z), tf_ros::Vector3(0,0,0)), ros::Time(t), "foo", "bar"));
      tf_.setTransform(StampedTransform(tf_ros::Transform(tf_ros::createIdentityQuaternion(), tf_ros::Vector3(1,0,0)), ros::Time(t), "foo", "stationary_offset_child"));
      tf_.setTransform(StampedTransform(tf_ros::Transform(tf_ros::createIdentityQuaternion(), tf_ros::Vector3(0,0,-1)), ros::Time(t), "stationary_offset_parent", "foo"));
    }
