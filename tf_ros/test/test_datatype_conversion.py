...
class PoseConversions(unittest.TestCase):
    def setUp(self):
        ...
        self.tfpose_stamped = tf_ros.PoseStamped()
        ...
        self.tfpoint_stamped = tf_ros.PointStamped()
        ...
        self.tfvector_stamped = tf_ros.VectorStamped()
        ...
        self.tfquaternion_stamped = tf_ros.QuaternionStamped()
    ...
    def test_msg_operator_on_converted(self):
        self.assertEquals(tf_ros.pose_stamped_bt_to_msg(self.tfpose_stamped), tf_ros.pose_stamped_bt_to_msg(self.tfpose_stamped), "pose msg test correctness after conversion")

    def test_bt_operator_on_converted(self):
        self.assertEquals(tf_ros.pose_stamped_msg_to_bt(self.msgpose_stamped), tf_ros.pose_stamped_msg_to_bt(self.msgpose_stamped), "pose bt test correctness after conversion")

    def test_to_msg_pose(self):
        self.assertEquals(tf_ros.pose_bt_to_msg(self.tfpose_stamped.pose), self.msgpose_stamped.pose, "pose tf_ros to msg incorrect")
    def test_to_tf_pose(self):
        self.assertEquals(tf_ros.pose_msg_to_bt(self.msgpose_stamped.pose), self.tfpose_stamped.pose, "pose stamped msg to tf_ros incorrect")

    def test_stamped_to_msg_pose(self):
        self.assertEquals(tf_ros.pose_stamped_bt_to_msg(self.tfpose_stamped), self.msgpose_stamped, "pose stamped tf_ros to msg incorrect")
    def test_stamped_to_tf_pose(self):
        self.assertEquals(tf_ros.pose_stamped_msg_to_bt(self.msgpose_stamped), self.tfpose_stamped, "pose stamped msg to tf_ros incorrect")
        

        
    # Test Point conversions
    def test_bt_operator_equal_point(self):
        self.assertEquals(self.tfpoint_stamped, self.tfpoint_stamped, "point tf_ros test correctness")
    ...
    def test_msg_operator_equal_point_converted(self):
        self.assertEquals(tf_ros.point_stamped_bt_to_msg(self.tfpoint_stamped), tf_ros.point_stamped_bt_to_msg(self.tfpoint_stamped), "point msg test correctness after conversion")

    def test_bt_operator_equal_point_converted(self):
        self.assertEquals(tf_ros.point_stamped_msg_to_bt(self.msgpoint_stamped), tf_ros.point_stamped_msg_to_bt(self.msgpoint_stamped), "point bt test correctness after conversion")

    def test_to_msg_point(self):
        self.assertEquals(tf_ros.point_bt_to_msg(self.tfpoint_stamped.point), self.msgpoint_stamped.point, "point tf_ros to msg incorrect")
    def test_to_tf_point(self):
        self.assertEquals(tf_ros.point_msg_to_bt(self.msgpoint_stamped.point), self.tfpoint_stamped.point, "point stamped msg to tf_ros incorrect")

    def test_stamped_to_msg_point(self):
        self.assertEquals(tf_ros.point_stamped_bt_to_msg(self.tfpoint_stamped), self.msgpoint_stamped, "point stamped tf_ros to msg incorrect")
    def test_stamped_to_tf_point(self):
        self.assertEquals(tf_ros.point_stamped_msg_to_bt(self.msgpoint_stamped), self.tfpoint_stamped, "point stamped msg to tf_ros incorrect")
    ...
    def test_msg_operator_equal_vector_converted(self):
        self.assertEquals(tf_ros.vector_stamped_bt_to_msg(self.tfvector_stamped), tf_ros.vector_stamped_bt_to_msg(self.tfvector_stamped), "vector msg test correctness after conversion")

    def test_bt_operator_equal_vector_converted(self):
        self.assertEquals(tf_ros.vector_stamped_msg_to_bt(self.msgvector_stamped), tf_ros.vector_stamped_msg_to_bt(self.msgvector_stamped), "vector bt test correctness after conversion")

    def test_to_msg_vector(self):
        self.assertEquals(tf_ros.vector_bt_to_msg(self.tfvector_stamped.vector), self.msgvector_stamped.vector, "vector tf_ros to msg incorrect")
    def test_to_tf_vector(self):
        self.assertEquals(tf_ros.vector_msg_to_bt(self.msgvector_stamped.vector), self.tfvector_stamped.vector, "vector stamped msg to tf_ros incorrect")

    def test_stamped_to_msg_vector(self):
        self.assertEquals(tf_ros.vector_stamped_bt_to_msg(self.tfvector_stamped), self.msgvector_stamped, "vector stamped tf_ros to msg incorrect")
    def test_stamped_to_tf_vector(self):
        self.assertEquals(tf_ros.vector_stamped_msg_to_bt(self.msgvector_stamped), self.tfvector_stamped, "vector stamped msg to tf_ros incorrect")
    ...
    def test_msg_operator_equal_quaternion_converted(self):
        self.assertEquals(tf_ros.quaternion_stamped_bt_to_msg(self.tfquaternion_stamped), tf_ros.quaternion_stamped_bt_to_msg(self.tfquaternion_stamped), "quaternion msg test correctness after conversion")

    def test_bt_operator_equal_quaternion_converted(self):
        self.assertEquals(tf_ros.quaternion_stamped_msg_to_bt(self.msgquaternion_stamped), tf_ros.quaternion_stamped_msg_to_bt(self.msgquaternion_stamped), "quaternion bt test correctness after conversion")

    def test_to_msg_quaternion(self):
        self.assertEquals(tf_ros.quaternion_bt_to_msg(self.tfquaternion_stamped.quaternion), self.msgquaternion_stamped.quaternion, "quaternion tf_ros to msg incorrect")
    def test_to_tf_quaternion(self):
        self.assertEquals(tf_ros.quaternion_msg_to_bt(self.msgquaternion_stamped.quaternion), self.tfquaternion_stamped.quaternion, "quaternion stamped msg to tf_ros incorrect")

    def test_stamped_to_msg_quaternion(self):
        self.assertEquals(tf_ros.quaternion_stamped_bt_to_msg(self.tfquaternion_stamped), self.msgquaternion_stamped, "quaternion stamped tf_ros to msg incorrect")
    def test_stamped_to_tf_quaternion(self):
        self.assertEquals(tf_ros.quaternion_stamped_msg_to_bt(self.msgquaternion_stamped), self.tfquaternion_stamped, "quaternion stamped msg to tf_ros incorrect")
if __name__ == '__main__':
    import rostest
    rostest.unitrun('tf_ros', 'test_tf_data_conversions', PoseConversions)
